...
function scrollUp(){
    ...
    // Wne the scroll is higher than 350 viewport height, add the show-scroll class to the 'a' tag with the 'scroll-top' class
...
sr.reveal(`.home__img, .new__card, .footer__container`)
